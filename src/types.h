...
const int PLY_MAX = 216;
const int PLY_MAX_PLUS_2 = PLY_MAX + 6;
...
enum Value {
  ...
  NonPawnMidgame = 4 * KnightValueMidgame + 4 * BishopValueMidgame + 4 * RookValueMidgame + 2 * QueenValueMidgame,  
...
const Value PieceValueMidgame[8] = {
  VALUE_ZERO,
  PawnValueMidgame, KnightValueMidgame, BishopValueMidgame,
  RookValueMidgame, QueenValueMidgame, VALUE_ZERO,
  VALUE_ZERO};

const Value PieceValueEndgame[8] = {
  VALUE_ZERO,
