...
const Bitboard Border = FileABB | FileHBB | Rank1BB | Rank8BB;
const Bitboard mask7pawn = FileABB | FileCBB | FileFBB | FileHBB;

const Bitboard WhiteBorder = Border & (Rank1BB | Rank2BB | Rank3BB | Rank4BB);
const Bitboard BlackBorder = Border & (Rank8BB | Rank7BB | Rank6BB | Rank5BB);
