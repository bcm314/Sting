...
static const string AppName = "Sting";
static const string EngineVersion = "11.2";
static const string AppTag  = "based on Stockfish 2.1.1";
...
const string engine_name() {
  ...
  if (!EngineVersion.empty())
      return AppName + " " + EngineVersion + " " + AppTag + cpu64;
